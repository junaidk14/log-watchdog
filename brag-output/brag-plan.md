# Brag plan: Log Watchdog

Invocation: --duration 18 --tone polished. Landscape 1920×1080, 30 fps. Narration off. Music and sparse SFX on. Run started 2026-09-20 03:51:53 UTC.
...
8. Share caption: Introducing Log Watchdog: follow an error-log spike from overview to evaluated evidence and delivery history, with optional Gemini analysis.
9. User flow: notice historical spike → investigate its evidence → verify notification → optionally preview for Gemini.

## Angle and visual identity
Follow the evidence. The incident is recovered, but its abnormal measurement remains inspectable. Never imply current failure or proven root cause. Preserve the dark app palette: ground #131b22, text #e4edf2, muted #afc0cd, accent #86c6df, error #ffadb2. System sans typography, medium-weight large captions; genuine screenshot crops take priority. No invented UI or output. Same product chrome across scenes; quiet crossfades and small reveals, generous held reading time.

## Storyboard — exactly 18 seconds
| Time | Scene | Visible caption and actual UI | Motion / audio |
| --- | --- | --- | --- |
| 0–3 | Overview hook | “One spike. A clear trail.” Overview crop shows Demo guide and recovered incident. Brand stays visible. | Already legible first frame; short gentle image settle. Quiet music fade-in. |
