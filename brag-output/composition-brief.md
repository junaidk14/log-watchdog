# Hyperframes composition brief: Log Watchdog
...
Hyperframes core, animation, creative, keyframes and CLI guidance loaded from the official repository because the installed plugin is older. Use one registered deterministic paused GSAP timeline, local media/runtime, five timed scenes, soft short crossfades. No generic launch-workflow interview. The user's explicit request to make the launch video authorizes local rendering; no publishing or feedback submission.

Audio: copied vol-12 music as assets/music.mp3; 0.18 volume, gentle entrance/end fades. Cue preset: /Users/junaidahamad/.agents/skills/brag/assets/music/cues/happy-beats-business-moves-vol-12-by-ende-dot-app.music-cues.json. SFX analysis read; use quiet click at investigation and warm soft accent at delivery. If official audio-data extraction is unavailable, document and omit reactive treatment. No narration. No cloud services, credentials or provider calls. Disable Hyperframes telemetry for check/preview/render.

Run full hyperframes check, inspect settled snapshots, start preview, render locally, select a settled UI-led poster and bake it as frame zero with unchanged duration/audio. Save share-copy.txt and verification notes.
