...
18-second polished product film, 1920×1080 at 30fps. No narration. Quiet music and two sparse SFX. Actual synthetic UI crops follow Overview → incident investigation → evaluated evidence → delivery history → optional Gemini setup. No Gemini output or key is shown.
...
Source UI: `../docs/screenshots/`, captured from safe synthetic data. Delivery shows the recorded single-attempt HTTP 200 opening notification, not a 503→200 success sequence. Gemini is optional and unconfigured. Screenshot cuts illustrate navigation; this is an edited product film, not a continuous live screen recording.
