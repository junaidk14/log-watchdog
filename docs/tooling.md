...
| Playwriter CLI / local headless Chrome | Used | Rendered desktop/narrow inspection, keyboard/Back/Forward, targeted motion and theme checks; extension mode failed to attach |
